...
const index_js_9 = __importDefault(require('./collections/filters/index.js'));
const index_js_10 = __importDefault(require('./users/index.js'));
...
function client(params) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const ifc = {
      ...
      users: (0, index_js_10.default)(connection),
